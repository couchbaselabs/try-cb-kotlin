# Couchbase Kotlin Travel-Sample Application

This is a sample application for getting started with [Couchbase Server] and the [Kotlin SDK].
The application runs a single page web UI for demonstrating SQL for Documents (N1QL), Sub-document requests and Full Text Search (FTS) querying capabilities.
It uses Couchbase Server together with the [Spring Boot] web framework for [Kotlin], [Swagger] for API documentation, [Vue] and [Bootstrap].
...
To download the application you can either download [the archive](https://github.com/couchbaselabs/try-cb-kotlin/archive/master.zip) or clone the repository:

    git clone https://github.com/couchbaselabs/try-cb-kotlin.git
...
This will start the Kotlin backend, Couchbase Server 7.0.0 and the Vue frontend app.
...
### Running the Kotlin API application manually

You may want to run the Kotlin application yourself, to make rapid changes to it,
...
[Kotlin SDK]: https://docs.couchbase.com/kotlin-sdk/current/hello-world/overview.html
